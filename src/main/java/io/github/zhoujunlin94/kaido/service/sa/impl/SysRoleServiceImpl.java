package io.github.zhoujunlin94.kaido.service.sa.impl;
...
import io.github.zhoujunlin94.kaido.repository.db.handler.base.SysResourceHandler;
import io.github.zhoujunlin94.kaido.repository.db.handler.base.SysRoleHandler;
import io.github.zhoujunlin94.kaido.repository.db.handler.base.SysRoleResourceHandler;
import io.github.zhoujunlin94.kaido.repository.db.handler.base.SysUserRoleHandler;
...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public boolean create(SysRoleDTO roleDTO, Integer loginUserId) {
        ...
        if (roleHandler.insertSelective(entity) == 1) {
            ...
            roleResourceHandler.batchInsertSelective(roleResourceEntityList);
            return true;
        }
        return false;
    }
    ...
    public boolean update(SysRoleDTO roleDTO, Integer loginUserId) {
        ...
        roleResourceHandler.batchInsertSelective(insertList);
